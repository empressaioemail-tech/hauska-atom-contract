 ...
 *
 * P-167: moved verbatim from hauska-map
 * `apps/property-explorer/src/lib/buildable-display-vocab.test.ts`; only the
 * relative import below changed (`./buildable-display-vocab` → `./buildable`).
 */
